...
async def start(client, message):
    if len(message.command) > 1:
        if message.command[1] == 'help':
            ...
            await message.reply("Learn to use the Agora VCBot, Showing help menu, Choose from the below options.",
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/agora_robots'),
            InlineKeyboardButton('🧩 Source', url='https://github.com/MR-AGORA')
        ],
        [
...
async def show_help(client, message):
    ...
    Config.msg['help'] = await message.reply_text(
        "Learn to use the Agora VCBot, Showing help menu, Choose from the below options.",
        reply_markup=reply_markup,
        disable_web_page_preview=True
        )
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 Repository', url='https://github.com/MR-AGORA'),
            InlineKeyboardButton('⚙️ Update Channel', url='https://t.me/agora_robots'),     
        ],
        [
            InlineKeyboardButton("🎞 How to Deploy", url='https://t.me/team_agora'),
            InlineKeyboardButton('🗑 Close', callback_data='close'),
        ]
    ]
    await message.reply("<b>The source code of this bot is public and can be found at <a href=https://github.com/MR-AGORA/AGORA-VCBOT>VCPlayerBot.</a>\nYou can deploy your own bot and use in your group.\n\nFeel free to star☀️ the repo if you liked it 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
